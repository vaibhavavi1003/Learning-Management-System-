						...
						<div class="panel-body">
							<div class="table-responsive">
								<table class="table table-striped table-bordered table-hover">
									<%
										ResultSet rs = DatabaseConnection.getResultFromSqlQuery("select * from user where email='" + session.getAttribute("email") + "' ");
										while (rs.next()) {
									%>
									<tbody>
										<tr>
											<td><strong>User Photo</strong></td>
											<td><image src="uploads/<%=rs.getString(8)%>"
													width="100" height="100"></image></td>
										</tr>
										<tr>
