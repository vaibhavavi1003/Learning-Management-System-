	...
	<div class="navbar navbar-inverse set-radius-zero">
		<div class="container">
			<div class="navbar-header">
				...
				<a class="navbar-brand" href="index.jsp"> <h1>Course Management System</h1></a>
			</div>
		</div>
	</div>
	...
	<div class="content-wrapper">
		<div class="container">
			<div class="row pad-botm">
				<div class="col-md-12">
					<h4 class="header-line">Admin Register</h4>
				</div>
			</div>
			<%
			...
			%>
			<div class="alert alert-info" id="info">Admin account created.</div>
			<%
				}
			%>
			<div class="row">
					...
					<div class="panel panel-danger">
						...
						<div class="panel-body">
							<form action="AdminAccount" method="post">
								...
								<input type="reset" value="Clear" class="btn btn-danger">|| <a href="adminLogin.jsp">Already have account please login</a>
							</form>
						</div>
					</div>
				</div>
