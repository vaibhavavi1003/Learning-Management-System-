...
<body>
	...
	<div class="content-wrapper">
		<div class="container">
			...
			<%
				String contact = (String) session.getAttribute("contact-us");
				if (contact != null) {
				session.removeAttribute("contact-us");
			%>
			<div class="alert alert-info" id="info">Thank you for contacting with us, we will get back and touch with you.</div>
			<%
				}
			%>
			<div class="row">
				<div class="col-md-6 col-sm-6 col-xs-12">
					<img src="images/contact-us.jpg" class="img-thumbnail"
