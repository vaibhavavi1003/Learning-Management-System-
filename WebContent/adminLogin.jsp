		...
		<div class="container">
			...
			<div class="row">
				<div class="col-md-6 col-sm-6 col-xs-12">
					<img src="images/admin-login-logo.jpg" class="img-thumbnail"
						alt="Cinque Terre" style="width: 500px; height: 330px;">
				</div>
				<div class="col-md-6 col-sm-6 col-xs-12">
					<div class="panel panel-danger">
						...
						<div class="panel-body">
							<form action="AdminLogin" method="post">
								...
								<a href="admin-register.jsp">Click Here To New Admin Account</a>
							</form>
						</div>
					</div>
				</div>
